...
namespace Lego.Ev3.Core
{
	...
	public sealed class Command
	{
        ...
        public void StartMotorAtPower(OutputPort ports, int power = 100)
        {
        ...
        public void PlaySound(int volume, string filename, bool loop = false)
        {
            if (volume < 0 || volume > 100)
                throw new ArgumentException("Volume must be between 0 and 100", "volume");
            Opcode loopCode = loop ? Opcode.Sound_Repeat : Opcode.Sound_Play;
            AddOpcode(loopCode);
